let MIDIInput = /** @class */ (() => {
    ...
    MIDIInput.onNoteOn = (note, velocity) => { return; };
    MIDIInput.onNoteOff = (note, velocity) => { return; };
    return MIDIInput;
})();
export { MIDIInput };
let midi;
...
function onMIDIMessage(event) {
    ...
    const cmd = data[0] >> 4, channel = data[0] & 0xf, type = data[0] & 0xf0, // channel agnostic message type. Thanks, Phil Burk.
